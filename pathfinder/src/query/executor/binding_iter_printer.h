...
public:
    ...
    virtual void visit(HashJoinGrace&)             override;
    virtual void visit(HashJoinInBuffer&)          override;
    virtual void visit(HashJoinInMemory&)          override;
    virtual void visit(LeftCrossProduct&)          override;
