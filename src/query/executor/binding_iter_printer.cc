...
public:
        ...
        printer(printer)
    {
        if (printer.print_stats) {
            ...
            printer.os << "[executions: " << binding_iter.executions;
...
void BindingIterPrinter::visit(HashJoinGrace& binding_iter) {
    auto helper = BindingIterPrinterHelper("HashJoinGrace", *this, binding_iter);
    os << ")\n";
    binding_iter.lhs->accept_visitor(*this);
    binding_iter.rhs->accept_visitor(*this);
}
...
void BindingIterPrinter::visit(HashJoinInBuffer& binding_iter) {
    auto helper = BindingIterPrinterHelper("HashJoinInBuffer", *this, binding_iter);
    os << ")\n";
    binding_iter.lhs->accept_visitor(*this);
    binding_iter.rhs->accept_visitor(*this);
}
...
void BindingIterPrinter::visit(HashJoinInMemory& binding_iter) {
    auto helper = BindingIterPrinterHelper("HashJoinInMemory", *this, binding_iter);
    os << ")\n";
    binding_iter.lhs->accept_visitor(*this);
    binding_iter.rhs->accept_visitor(*this);
}
...
void BindingIterPrinter::visit(LeftCrossProduct& binding_iter) {
    auto helper = BindingIterPrinterHelper("LeftCrossProduct", *this, binding_iter);
    os << ")\n";
    binding_iter.lhs->accept_visitor(*this);
    binding_iter.rhs->accept_visitor(*this);
}
