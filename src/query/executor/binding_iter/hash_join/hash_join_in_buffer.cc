...
void HashJoinInBuffer::_begin(Binding& _parent_binding) {
...
void HashJoinInBuffer::accept_visitor(BindingIterVisitor& visitor) {
    visitor.visit(*this);
}
